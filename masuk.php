<?php
require('template/header.php') ; require('ceklogin.php'); 
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                ...
                                <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#myModal">Tambah Barang Masuk</button>
            ...
            <div class="modal-content">
                ...
                <form method="POST">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-success" name= "barangmasuk">Tambah</button>
